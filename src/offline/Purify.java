...
public class Purify {
	public static void main(String[] args) {
		...
		String fileName = "C:\\Users\\chuyi\\Downloads\\eclipse-jee-2018-12-R-win32-x86_64\\tomcat_log.txt";

		try {
			db.getCollection("logs").drop();
			//read each line of log
			FileReader fileReader = new FileReader(fileName);
			BufferedReader bufferedReader = new BufferedReader(fileReader);
			String line = null;
			while ((line = bufferedReader.readLine()) != null) {
				// Sample input: 
				// (ip)73.223.210.212 - - [19/Aug/2017:22:00:24 +0000] "GET /Titan/history?user_id=1111 HTTP/1.1" 200 11410
